...
OptimizationParams = dict(
    ...
    region_lr = 0.01,
    spatial_lr = 1e-6, #0.001, # 0.01
    illumination_embedding_lr= 0.0001, # 0.01
    
    region_lr_fine = 0.01, # 0.001,
    region_lr_fine_final = 0.0001, # 0.001,
    
    spatial_lr_fine = 1e-6, #0.001, #0.0001,
    spatial_lr_fine_final = 1e-7, #0.00001, #0.0001,
    
    illumination_embedding_lr_fine = 0.001,
    illumination_embedding_lr_fine_final = 0.00001,
