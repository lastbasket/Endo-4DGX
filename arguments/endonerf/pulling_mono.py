...
OptimizationParams = dict(
    ...
    deformation_lr_final = 0.0000016, #0.0000016,
    deformation_lr_delay_mult = 0.01,
    grid_lr_init = 0.0016, #0.0016,
    grid_lr_final = 0.000016, #0.000016,
    iterations = 7000,
    percent_dense = 0.01,
